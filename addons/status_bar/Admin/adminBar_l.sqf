...
disableSerialization;
	...
	_rscLayer = "largeStatusBarAdmin" call BIS_fnc_rscLayer;
	_rscLayer cutRsc["largeStatusBarAdmin","PLAIN"];
	...
	while {true} do 
	{
		...
		if(isNull ((uiNamespace getVariable "largeStatusBarAdmin")displayCtrl 55556)) then
		{
		...
		_colourStamina = _colourDefault;
			...
			((uiNamespace getVariable "largeStatusBarAdmin")displayCtrl 55556)ctrlSetStructuredText parseText 
			format["
			...
			<t shadow='1' shadowColor='#000000' color='%17'><img size='1.0'  shadowColor='#000000' image='addons\status_bar\images\toxicity.paa' color='%17'/>%18</t> 
			...
			<t shadow='1' shadowColor='#000000' color='%10'><img size='1.0'  shadowColor='#000000' image='addons\status_bar\images\restart.paa' color='%10'/>%19:%20</t>

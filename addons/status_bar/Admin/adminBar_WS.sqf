...
disableSerialization;
	...
	while {true} do 
	{
		...
		if(isNull ((uiNamespace getVariable "osefStatusBarAdminWS")displayCtrl 55558)) then
		{
		...
		((uiNamespace getVariable "osefStatusBarAdminWS")displayCtrl 55558)ctrlSetStructuredText parseText 
			format["

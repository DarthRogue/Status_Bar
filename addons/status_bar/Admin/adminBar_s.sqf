...
disableSerialization;
	...
	_rscLayer = "smallStatusBarAdmin" call BIS_fnc_rscLayer;
	_rscLayer cutRsc["smallStatusBarAdmin","PLAIN"];
	...
	while {true} do 
	{
		...
		if(isNull ((uiNamespace getVariable "smallStatusBarAdmin")displayCtrl 55554)) then
		{
		...
		_colourStamina = _colourDefault;
			...
			((uiNamespace getVariable "smallStatusBarAdmin")displayCtrl 55554)ctrlSetStructuredText parseText 
			format["

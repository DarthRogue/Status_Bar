...
disableSerialization;
	...
	_rscLayer = "normalStatusBar" call BIS_fnc_rscLayer;
	_rscLayer cutRsc["normalStatusBar","PLAIN"];
	...
	while {true} do 
	{
		...
		if(isNull ((uiNamespace getVariable "normalStatusBar")displayCtrl 55561)) then
		{
		...
		((uiNamespace getVariable "normalStatusBar")displayCtrl 55561)ctrlSetStructuredText parseText 
			format["
			...
			<t shadow='1' shadowColor='#000000' color='%19'><img size='1.2'  shadowColor='#000000' image='addons\status_bar\images\toxicity.paa' color='%19'/>%20</t>

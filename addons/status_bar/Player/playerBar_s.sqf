...
disableSerialization;
	...
	_rscLayer = "smallStatusBar" call BIS_fnc_rscLayer;
	_rscLayer cutRsc["smallStatusBar","PLAIN"];
	...
	while {true} do 
	{
		...
		if(isNull ((uiNamespace getVariable "smallStatusBar")displayCtrl 55560)) then
		{
		...
		((uiNamespace getVariable "smallStatusBar")displayCtrl 55560)ctrlSetStructuredText parseText 
			format["

...
disableSerialization;
	...
	_rscLayer = "verySmallStatusBar" call BIS_fnc_rscLayer;
	_rscLayer cutRsc["verySmallStatusBar","PLAIN"];
	...
	while {true} do 
	{
		...
		if(isNull ((uiNamespace getVariable "verySmallStatusBar")displayCtrl 55559)) then
		{
		...
		((uiNamespace getVariable "verySmallStatusBar")displayCtrl 55559)ctrlSetStructuredText parseText 
			format["
			...
			<t shadow='1' shadowColor='#000000' color='%19'><img size='1.7'  shadowColor='#000000' image='addons\status_bar\images\toxicity.paa' color='%19'/>%20</t>

...
disableSerialization;
	...
	_rscLayer = "veryLargeStatusBar" call BIS_fnc_rscLayer;
	_rscLayer cutRsc["veryLargeStatusBar","PLAIN"];
	...
	while {true} do 
	{
		...
		if(isNull ((uiNamespace getVariable "veryLargeStatusBar")displayCtrl 55563)) then
		{
		...
		((uiNamespace getVariable "veryLargeStatusBar")displayCtrl 55563)ctrlSetStructuredText parseText 
			format["
